// JavaScript Document
$(function(){
	//$(".content_One_threeNews_Text").eq(0).show().siblings(".content_One_threeNews_Text").hide();
	$("#first1").show();
	$("#first2").hide();
	$("#first3").hide();
	$(".content_One_threeNews_meunUl li").each(function(index, element) {
        $(this).click(function(){
			changeIco1(index);
		});
    });
	function changeIco1(index){
		if(index == 0){
			$(".content_One_threeNewsIco").animate({top:'40px'},function(){
				$(".content_One_threeNewsIco").removeClass("threeNewsIcoB");
				$(".content_One_threeNewsIco").removeClass("threeNewsIcoC");
				$(".content_One_threeNewsIco").addClass("threeNewsIcoA");	
				$("#first1").show();
				$("#first2").hide();
				$("#first3").hide();
				//$(".content_One_threeNews_Text").eq(index).show().siblings(".content_One_threeNews_Text").hide();
			});
		}
		else if(index == 1){
			$(".content_One_threeNewsIco").animate({top:'156px'},function(){
				$(".content_One_threeNewsIco").removeClass("threeNewsIcoA");
				$(".content_One_threeNewsIco").removeClass("threeNewsIcoC");
				$(".content_One_threeNewsIco").addClass("threeNewsIcoB");
				$("#first1").hide();
				$("#first2").show();
				$("#first3").hide();
				//$(".content_One_threeNews_Text").eq(index).show().siblings(".content_One_threeNews_Text").hide();
			...
			$(".content_One_threeNewsIco").animate({top:'270px'},function(){
				$(".content_One_threeNewsIco").removeClass("threeNewsIcoA");
				$(".content_One_threeNewsIco").removeClass("threeNewsIcoB");
				$(".content_One_threeNewsIco").addClass("threeNewsIcoC");
				$("#first1").hide();
				$("#first2").hide();
				$("#first3").show();
				//$(".content_One_threeNews_Text").eq(index).show().siblings(".content_One_threeNews_Text").hide();
