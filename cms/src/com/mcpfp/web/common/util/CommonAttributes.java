...
public final class CommonAttributes {
	...
	public static String back_domain="";//后端服务器的域名
	public static String app_domain="";//手机的域名
	
	public static String member_modify = "";//修改会员的权限配置
	static{
		Configuration cfg=GlobalConfig.getInstance().getConfig("common_config");
		fore_domain = cfg.getString("fore.domain");
		member_modify = cfg.getString("member.modify");
		//back_domain=cfg.getString("back.domain");
		//app_domain=cfg.getString("app.domain");
	}
}