...
public class CmdLineOptions {
	...
	public static String extractRecognitionLanguage(Vector<String> args) {
		...
		System.out.println("Warning! The document will be processed with English language.\n"
	 ...
	 */
	public static String extractParameterValue(String parameterName, Vector<String> args) {
