package com.cms.web.common.util.recognition.IK;
...
class CharUtil {
	...
	public static final int CHAR_SPECIAL = 0X00000006;
	
	public static final int CHAR_OTHER_CJK = 0X00000008;
	
	public static final int CHAR_LINE_SYMBOL = 0X00000010;
	...
	static int identifyCharType(char input){
		...
		if(0x2028 == input || 0x2029 == input){
			System.out.println("there is a paragraph or line symbol");
			return CHAR_LINE_SYMBOL;
		}
